    ...
    <footer className="bg-black text-white py-16 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a href="#home" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('nav.home')}
              </a>
              <a href="#services" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('nav.services')}
              </a>
              <a href="#story" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('nav.ourStory')}
              </a>
              <a href="#contact" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('nav.contact')}
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a href="#services" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('footer.brandStrategy')}
              </a>
              <a href="#services" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('footer.marketing')}
              </a>
              <a href="#services" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('footer.digitalProducts')}
              </a>
              <a href="#services" className="block text-white/70 hover:text-white transition-colors duration-300 text-sm">
                {t('footer.webDesign')}
              </a>
        ...
        <button
          ...
          className="fixed bottom-8 right-8 w-12 h-12 bg-black border-2 border-white rounded-full shadow-xl flex items-center justify-center text-white hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-110 z-50"
